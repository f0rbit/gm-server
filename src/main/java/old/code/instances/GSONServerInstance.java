...
public abstract class GSONServerInstance implements ServerInterface {
    ...
    /**
     * This server instance's {@link old.code.networks.TCPServer}, initiated when calling constructor.
     */
    @Getter @Setter private DataServer TCPServer;

    /**
     * This server instance's {@link old.code.networks.UDPServer}, initiated when calling constructor.
     */
