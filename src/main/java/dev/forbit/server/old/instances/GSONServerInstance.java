...
import dev.forbit.server.old.ServerType;
import dev.forbit.server.old.networks.DataServer;
import dev.forbit.server.old.networks.QueryServer;
import dev.forbit.server.old.networks.gson.GsonTCPServer;
import dev.forbit.server.old.networks.gson.GsonUDPServer;
...
public abstract class GSONServerInstance implements ServerInterface {
    ...
    /**
     * This server instance's {@link dev.forbit.server.old.networks.TCPServer}, initiated when calling constructor.
     */
    @Getter @Setter private DataServer TCPServer;

    /**
     * This server instance's {@link dev.forbit.server.old.networks.UDPServer}, initiated when calling constructor.
     */
